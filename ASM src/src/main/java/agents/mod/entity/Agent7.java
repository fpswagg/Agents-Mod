...
public class Agent7 extends EntityMob
{

	public Agent7(World world) 
	{
		super(world);
        ...
        this.tasks.addTask(5, new EntityAITempt(this, 1.2D, AgentsMod.red, false));
    ...
    {
        return AgentsMod.diamond0;
    }
	
	protected void addRandomArmor()
    {
        this.setCurrentItemOrArmor(0, new ItemStack(AgentsMod.red0));
    }
