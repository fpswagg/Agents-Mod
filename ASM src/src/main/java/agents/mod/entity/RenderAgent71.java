...
public class RenderAgent71 extends RenderBiped{

	public RenderAgent71(ModelBiped model, float shadowSize)
	{
	...
	{
		return new ResourceLocation("asm:textures/entity/a71.png");
