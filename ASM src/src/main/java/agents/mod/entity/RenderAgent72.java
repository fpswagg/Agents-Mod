...
public class RenderAgent72 extends RenderBiped{

	public RenderAgent72(ModelBiped model, float shadowSize)
	{
	...
	{
		return new ResourceLocation("asm:textures/entity/a72.png");
