...
public class RenderAgent491 extends RenderBiped{

	public RenderAgent491(ModelBiped model, float shadowSize)
	{
	...
	{
		return new ResourceLocation("asm:textures/entity/a491.png");
