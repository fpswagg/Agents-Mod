...
public class BAgent7 extends EntityMob
{

	public BAgent7(World world) 
	{
		super(world);
        ...
        this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, Burner.class, 0, true));
	}
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(374.0F);
    ...
    {
        return "mob.witch.angry";
    }
	
	protected Item getDropItem()
    {
        return AgentsMod.red;
    }
	
	protected void addRandomArmor()
    {
		super.addRandomArmor();
        this.setCurrentItemOrArmor(0, new ItemStack(AgentsMod.red));
    }
