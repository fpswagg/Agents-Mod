...
public class RenderEnder1 extends RenderBiped{

	public RenderEnder1(ModelBiped model, float shadowSize)
	{
	...
	{
		return new ResourceLocation("asm:textures/entity/eb.png");
